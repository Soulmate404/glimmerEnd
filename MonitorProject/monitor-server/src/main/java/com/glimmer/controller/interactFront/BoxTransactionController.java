...
public class BoxTransactionController {
    ...
    private  final BoxTransactionService boxTransactionService;
@Autowired
public BoxTransactionController(BoxTransactionService boxTransactionService) {
    this.boxTransactionService = boxTransactionService;
}
/*
